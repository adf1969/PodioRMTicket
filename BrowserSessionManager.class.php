...
/**
 * Description of BrowserSessionManager
 *
 * @author fields
 * 
 * USAGE:
 * require_once('BrowserSessionManager.class.php');
 * Podio::setup(CLIENT_ID, CLIENT_SECRET, array('session_manager' => 'BrowserSessionManager'));
